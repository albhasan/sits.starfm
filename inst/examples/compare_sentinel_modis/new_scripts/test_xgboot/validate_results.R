...
my_recode <- c(Deforestatio = "Deforestation",
               Forest = "Forest",
...
samples_tb <- tibble::tribble(~used_bands, ~extra_samples_file,
                "blue-bnir-green-nnir-red-swir1-swir2", "/root/data/samples/validation_bands.rds",
                "evi-ndmi-ndvi",                        "/root/data/samples/validation_indices.rds") %>%
...
results_tb %>%
    ...
    dplyr::select(used_bands, def_pa, def_ua, def_f1, for_pa, for_ua, for_f1, nfo_pa, nfo_ua, nfo_f1) %>%
