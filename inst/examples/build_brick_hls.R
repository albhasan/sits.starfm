...
# Build a brick by piling Harmonized Landsat8-Sentinel2 images
...
option_list = list(
    ...
    make_option(c("-p", "--product"), type = "character", default = NULL, 
        help = "Harmonized Landsat8-Sentinel2 product e.g. L30",
        metavar = "character"),
...
brick_summary <- build_brick_hls_raw(in_dir, brick_tile, brick_product, 
                                     brick_from, brick_to, brick_bands, 
                                     brick_n_img, out_dir)
